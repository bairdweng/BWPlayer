...
- (uint8_t *)frameAudiobuffer;
- (long)frameAudiobufferLen;
- (int)frameAudiobufferChannel;
- (void)frameAudiobufferLock;
- (void)frameAudiobufferUnlock;
...
IJK_EXTERN NSString *const IJKMPMoviePlayerAudioCallBackGRTNotification;
@end
